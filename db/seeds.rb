...
user1 = User.create!(username: 'testuser1', uid: 'adfdf233', token: 'ajdkflk32jflkjfdsfkl23jrlk2fjadf', password: 'test123')
user2 = User.create!(username: 'testuser2', uid: 'abc123def', token: 'aldj2om2l23j2305', password: 'test123')
user3 = User.create!(username: 'testuser3', uid: 'asdf3333', token: 'kljkl4tlkj43lt2lk23', password: 'test123')
